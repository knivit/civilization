...
import com.tsoft.civilization.tile.resource.ResourceBaseState;
 ...
 */
public class AncientRuins extends AbstractResource {

    private static final ResourceBaseState BASE_STATE = ResourceBaseState.builder()
        .supply(Supply.builder().gold(30).build())
        .build();

    @Override
    public ResourceType getType() {
        return ResourceType.ANCIENT_RUINS;
    }
    ...
    public boolean acceptTile(AbstractTerrain tile) {
        return tile.isIn(Plains.class, Tundra.class, Desert.class, Grassland.class);
    }
