 ...
 * ------------------------------
 * Total :( Unhappiness level of the empire is 10
 * Empire is :( VERY unhappy! Cities stop growing, Settlers may not be trained,
 * (p) Production is greatly diminished and Units are less effective in combat!
 *
 * 202 total :) Happiness from all sources.
 *   * 55 from having AT LEAST ONE source of the following Luxury Resources:
 *      +5 from (w) Whales
 *      +5 from (p) Pearls
 *      +5 from (g) Gems
 *      ...
 *   * 0 from Social Policies
 *   * 131 from Buildings
 *   * 25 from Garrisoned Units
 *   * 7 from discovery of Natural Wonders
 *   * 9 from Difficulty Level
 *
 * 237 total :( Unhappiness from all sources.
 *   * 23.2 generated from number of Cities
 *   * 214 generated by (p) Population
 *
 * :) Happiness is necessary to keep your cities growing. It is used to counter
 * :( Unhappiness.
 *
 * Happiness
 * ---------
