package com.tsoft.civilization.unit.promotion.ranged;
...
public final class Accuracy2 implements Promotion {
    ...
    public boolean accept(AbstractUnit unit) {
        return unit.hasPromotions(PromotionType.Accuracy1);
    }
}
