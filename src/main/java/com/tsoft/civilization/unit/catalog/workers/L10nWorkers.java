...
public class L10nWorkers {
    ...
    public static final L10n CAN_BUILD_IMPROVEMENT = new L10n()
        .put("en", "Improvement can be built")
        .put("ru", "Улучшение может быть построено");
    ...
    public static final L10n FAIL_INAPPROPRIATE_TILE = new L10n()
        .put("en", "An inappropriate tile")
        .put("ru", "Неподходящяя ячейка");

    public static final L10n FAIL_IMPROVEMENT_ALREADY_EXISTS = new L10n()
        .put(EN, "An improvement on this tile already exists")
        .put(RU, "На этой клетке улучшение уже существует");

    public static final L10n FAIL_CANT_BUILD_IN_CITY_CENTER = new L10n()
        .put("en", "Can't build an improvement in a city's center")
        .put("ru", "Нельзя построить улучшение в центре города");
}
