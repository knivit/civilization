...
class Ruleset {
    ...
    HashMap<String, Belief> beliefs = new LinkedHashMap<>();
    HashMap<String, Building> buildings = new LinkedHashMap<>();
    HashMap<String, Difficulty> difficulties = new LinkedHashMap<>();
    HashMap<String, Era> eras = new LinkedHashMap<>();
    HashMap<String, Speed> speeds = new LinkedHashMap<>();
    var globalUniques = GlobalUniques()
    HashMap<String, Nation> nations = new LinkedHashMap<>();
    HashMap<String, Policy> policies = new LinkedHashMap<>();
    HashMap<String, PolicyBranch> policyBranches = new LinkedHashMap<>();
    List<String> religions = new ArrayList<>();
    HashMap<String, RuinReward> ruinRewards = new LinkedHashMap<>();
    HashMap<String, Quest> quests = new LinkedHashMap<>();
    HashMap<String, Specialist> specialists = new LinkedHashMap<>();
    HashMap<String, Technology> technologies = new LinkedHashMap<>();
    List<TechColumn> techColumns = new ArrayList<>();
    HashMap<String, Terrain> terrains = new LinkedHashMap<>();
    HashMap<String, TileImprovement> tileImprovements = new LinkedHashMap<>();
    HashMap<String, TileResource> tileResources = new LinkedHashMap<>();
    HashMap<String, BaseUnit> units = new LinkedHashMap<>();
    HashMap<String, Promotion> unitPromotions = new LinkedHashMap<>();
    HashMap<String, UnitType> unitTypes = new LinkedHashMap<>();
    HashMap<String, Victory> victories = new LinkedHashMap<>();
    HashMap<String, CityStateType> cityStateTypes = new LinkedHashMap<>();
    ...
    fun clear() {
        ...
        eras.clear();
        speeds.clear();
        globalUniques = new GlobalUniques();
        mods.clear();
        nations.clear();
        policies.clear();
