...
public class RemoveForestActionTest {
    ...
    public static void classSetUp() {
        DefaultLogger.createLogger(RemoveForestActionTest.class.getSimpleName());
    }
    ...
    public void removeForestedHill() {
        ...
        assertEquals(1, tile.getFeatures().size());
        assertNotNull(tile.getFeatures().getByClass(Hill.class));
        ...
        assertEquals(Grassland.class, tile.getClass());
        assertEquals(0, tile.getFeatures().size());
    }
}
