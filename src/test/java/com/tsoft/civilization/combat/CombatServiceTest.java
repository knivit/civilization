...
public class CombatServiceTest {
    ...
    public void get_targets_to_attack_for_melee_attacker() {
        ...
        HasCombatStrengthList targets = combatService.getTargetsToAttack(world.unit("warriors"));
        assertThat(targets)
            .hasSize(1)
        ...
        targets = combatService.getTargetsToAttack(world.unit("warriors"));
        assertThat(targets)
            .hasSize(2)
    ...
    public void get_targets_to_attack_for_ranged_attacker() {
        ...
        // look for targets
        HasCombatStrengthList targets = combatService.getTargetsToAttack(world.unit("archers"));
        assertThat(targets)
            .hasSize(6)
        ...
        assertThat(combatService.attack(world.unit("archers"), world.unit("foreignWarriors2")))
            .isNotNull()
        ...
        assertThat(combatService.attack(world.unit("archers"), world.unit("foreignArchers1")))
            .isNotNull()
        ...
        assertThat(combatService.attack(world.unit("archers"), world.city("foreignCity")))
            .isNotNull()
    ...
    public void warriors_conquer_foreign_city() {
        ...
        // strike 1
        assertThat(combatService.attack(world.unit("warriors1"), world.city("foreignCity")))
            .returns(true, CombatResult::isDone);
        ...
        // strike 2
        assertThat(combatService.attack(world.unit("warriors2"), world.city("foreignCity")))
            .returns(true, CombatResult::isDone);
        ...
        // strike 3
        assertThat(combatService.attack(world.unit("warriors3"), world.city("foreignCity")))
            .returns(true, CombatResult::isDone);
        ...
        // strike 4
        assertThat(combatService.attack(world.unit("warriors4"), world.city("foreignCity")))
            .returns(true, CombatResult::isDone)
            .returns(true, CombatResult::isTargetDestroyed);
