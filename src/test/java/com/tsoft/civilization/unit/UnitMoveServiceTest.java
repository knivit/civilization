...
public class UnitMoveServiceTest {
    ...
    public void fail_tile_occupied_in_city() {
        ...
        Set<Point> locations = unitMoveService.getLocationsToMove(workers);
    ...
    public void get_tiles_to_move() {
        ...
        Set<Point> locationsToMove = unitMoveService.getLocationsToMove(workers1);
    ...
    public void find_route1() {
        ...
        UnitRoute route = unitMoveService.findRoute(world.unit("workers"), new Point(1, 0));
